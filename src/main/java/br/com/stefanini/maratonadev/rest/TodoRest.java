...
//  METODO LISTAR
	@GET
	@Path("")
	@Operation(summary = "Listar listas a fazer", description = "Retorno uma lista de Todo.class")
...
//			});
	...
	@GET
	@Path("/{id}")
	@Operation(summary = "Buscar tarefa por ID", description = "Buscar tarefa por ID")
	...
	@PUT
	@Path("/{id}")
	@Operation(summary = "Editar uma tarefa com base o ID", description = "Editar uma tarefa com base o ID")
